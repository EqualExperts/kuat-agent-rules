...
| Extended pull-outs | If Logic Lime/Orange accents are used, only one per deck, dark text, never a full-bleed fill — see [styling.md](../../reference/media-types/slides/styling.md) → *Extended palette in decks (provisional)* |
