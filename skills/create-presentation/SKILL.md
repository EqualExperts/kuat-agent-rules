...
Build on-brand Equal Experts decks: one idea per slide, B&W photography, restrained layout variety, the page-number badge as the persistent brand cue. Standards live in [`/reference`](../../reference/README.md) — link, don't inline.

## Step 1 — Intake & "before you create"

Run the grouped intake ([../_shared/intake.md](../_shared/intake.md)), then settle the four slide-specific questions:
...
- Design language: [../../reference/design-language/](../../reference/design-language/)
