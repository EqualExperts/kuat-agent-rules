...
Same hard stop as [kuat-figma-design](../kuat-figma-design/SKILL.md) Step 0: confirm Equal
...
Run the shared intake ([../_shared/intake.md](../_shared/intake.md)), then pin the flow itself:
...
- **Missing** — build it via [kuat-figma-design](../kuat-figma-design/SKILL.md) (full skill, gates
...
- **Animation — restraint applies here too:** instant or dissolve is the default. Smart animate
  ...
  [composition.md](../../reference/design-language/composition.md)'s restraint principle, applied
...
link. Stamp per [../_shared/version-stamp.md](../_shared/version-stamp.md).
...
- [kuat-figma-design](../kuat-figma-design/SKILL.md) - builds any missing screens/states, gates included
- [kuat-figma-review-design](../kuat-figma-review-design/SKILL.md) - review the screens themselves
