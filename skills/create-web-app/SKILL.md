...
This skill **links** to the passive reference library; load only the slices you need, when you need them. Standards live in [`/reference`](../../reference/README.md) — never paste reference content inline.

## Step 1 — Intake

Run the grouped intake first: see [../_shared/intake.md](../_shared/intake.md). For web product, confirm at least:

- **Scenario / page type** — form, dashboard, documentation, auth flow, table, settings, etc.
- **Framework + deliverable** — React, Vue, or plain HTML/CSS? Code, or a mockup (Figma / Claude Design — if mockup, switch to [create-design](../create-design/SKILL.md))?
...
| Need | Load |
|------|------|
| Colour / type / spacing / radius tokens | [../../reference/design-language/](../../reference/design-language/) (colours, typography, spacing, borders) |
...
| Accessibility requirements | [../../reference/accessibility/accessibility.md](../../reference/accessibility/accessibility.md) + [../../reference/media-types/web-product/accessibility.md](../../reference/media-types/web-product/accessibility.md) |
...
**Token/layout syntax (illustrative only):** [../../reference/media-types/web-product/examples/](../../reference/media-types/web-product/examples/) shows React/Vue/CSS token usage. Treat it as syntax reference, **not** canonical component API — prefer component guides (Step 3).
...
Per-component API/usage/a11y is **not** in this repo — it ships with the implementation. Resolve by stable ID via [../../reference/media-types/web-product/component-registry.md](../../reference/media-types/web-product/component-registry.md):
...
- Build from the documented pattern in [../../reference/media-types/web-product/patterns/](../../reference/media-types/web-product/patterns/) + token syntax in `examples/`, using semantic tokens.
...
- **EE Blue for buttons/icons/CTAs (`primary`); the `link` semantic token for text links and small text** — never EE Blue for a text link, it fails small-text contrast. See [colour-modes.md](../../reference/media-types/web-product/colour-modes.md).
...
- [ ] One clear focal point per screen; density matches the content type (dense for dashboards/tables, generous for onboarding/empty states — see [composition.md](../../reference/design-language/composition.md) and the density table in [web-product/design.md](../../reference/media-types/web-product/design.md)); hierarchy uses scale/weight contrast, not colour alone
- [ ] Run the [observer gate](../_shared/observer-gate.md) as a fresh adversarial pass — the boxes above can all be ticked and the screen still be generic
- [ ] Version stamp applied — see [../_shared/version-stamp.md](../_shared/version-stamp.md)
...
- Review counterpart: [review-web-app](../review-web-app/SKILL.md)
- Mockups instead of code: [create-design](../create-design/SKILL.md)
- Shared: [intake](../_shared/intake.md) · [version-stamp](../_shared/version-stamp.md)
