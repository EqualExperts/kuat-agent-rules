...
for product UI, [reference/media-types/web-marketing/patterns/marketing-pages.md](${CLAUDE_PLUGIN_ROOT}/reference/media-types/web-marketing/patterns/marketing-pages.md)
for marketing).
...
**Before handoff:** run the [observer gate](${CLAUDE_PLUGIN_ROOT}/skills/_shared/observer-gate.md) — a separate, ruthless
...
- [claude-design-build-checklist](${CLAUDE_PLUGIN_ROOT}/skills/create-design/claude-design-build-checklist.md) - equivalent checklist for the Claude Design route
