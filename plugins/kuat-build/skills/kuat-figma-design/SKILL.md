...
- **If Kuat:** the target file defaults to Kuat2 — see [reference/media-types/web-product/design.md](${CLAUDE_PLUGIN_ROOT}/reference/media-types/web-product/design.md)
...
If reached via [create-design](${CLAUDE_PLUGIN_ROOT}/skills/create-design/SKILL.md), reuse its context, concept-count, and
fidelity answers instead of re-asking.

## Step 1 — Brief intake

Run the shared intake — [skills/_shared/intake.md](${CLAUDE_PLUGIN_ROOT}/skills/_shared/intake.md) — plus the design-specific
items:
...
- **Single design or multiple concepts?** Exploratory or comparative briefs default to 2-3 genuinely
  ...
  idea ([composition.md](${CLAUDE_PLUGIN_ROOT}/reference/design-language/composition.md), divergence principle).
...
- **Density:** which density default does this content type take — dense (dashboards, tables,
  ...
  density table in [reference/media-types/web-product/design.md](${CLAUDE_PLUGIN_ROOT}/reference/media-types/web-product/design.md)
...
Principles: [composition.md](${CLAUDE_PLUGIN_ROOT}/reference/design-language/composition.md). For multiple
...
the pre-handoff self-audit — then the [observer gate](${CLAUDE_PLUGIN_ROOT}/skills/_shared/observer-gate.md) as a fresh
adversarial pass. A checklist-clean build that fails the observer gate is not done.

Stamp the deliverable per [skills/_shared/version-stamp.md](${CLAUDE_PLUGIN_ROOT}/skills/_shared/version-stamp.md).
...
- [kuat-figma-prototype](${CLAUDE_PLUGIN_ROOT}/skills/kuat-figma-prototype/SKILL.md) - wire these screens into a clickable flow
- [kuat-figma-review-design](${CLAUDE_PLUGIN_ROOT}/skills/kuat-figma-review-design/SKILL.md) - review counterpart
- [create-design](${CLAUDE_PLUGIN_ROOT}/skills/create-design/SKILL.md) - upstream route decision (Figma vs Claude Design)
- [create-web-app](${CLAUDE_PLUGIN_ROOT}/skills/create-web-app/SKILL.md) - code deliverables instead of Figma
- [intake](${CLAUDE_PLUGIN_ROOT}/skills/_shared/intake.md) · [observer-gate](${CLAUDE_PLUGIN_ROOT}/skills/_shared/observer-gate.md) · [version-stamp](${CLAUDE_PLUGIN_ROOT}/skills/_shared/version-stamp.md)
