...
- **Figma route:** invoke [kuat-figma-design](${CLAUDE_PLUGIN_ROOT}/skills/kuat-figma-design/SKILL.md), passing the context
...
- [kuat-figma-design](${CLAUDE_PLUGIN_ROOT}/skills/kuat-figma-design/SKILL.md) - Figma route
...
- [figma-build-checklist](${CLAUDE_PLUGIN_ROOT}/skills/kuat-figma-design/figma-build-checklist.md) · [claude-design-build-checklist](./claude-design-build-checklist.md)
